...
public class CountMaximalValueRoots {
    ...
    private void traversal(Tree root, AtomicInteger count, AtomicInteger biggestValue) {
        ...
        } else if (isBigger(root.left, root.val) && isBigger(root.right, root.val) && root.val >= leftBiggest && root.val >= rightBiggest) {
    ...
    public static void main(String[] args) {
    	...
    	//Tree root = r.t(6, r.t(3,  null,  null),r.t(2, r.t(6, null, null), r.t(4, null, null)));
