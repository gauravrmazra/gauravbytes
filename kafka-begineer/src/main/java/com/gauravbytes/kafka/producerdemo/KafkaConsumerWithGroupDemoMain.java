 ...
 *
 */
public class KafkaConsumerWithGroupDemoMain {
	private static final Logger LOGGER = LoggerFactory.getLogger(KafkaConsumerWithGroupDemoMain.class);

	public static void main(String[] args) {
		// Create properties
		Properties consumerProperties = new Properties();
		String groupId = "java-consumer-application";
